...
export class RemotePlayer {
  ...
  constructor(name: string) {
    ...
    // No shadow casting — extra shadow-map geometry per remote player was
    // additive WebGL cost the renderer's lighting/shadow budget was never
    // tuned to include (see RemotePlayer perf analysis).
