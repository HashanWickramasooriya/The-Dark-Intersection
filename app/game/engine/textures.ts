...
export const PAGE_TEXTS: string[][] = [
  ["1 වෙනි දා?", "කාර්යාල බිම හරහා", "රිංගුණා. කාපට්", "තෙතමනයි. හඬ", "නවතින්නෙම නෑ."],
  ["එය ඇවිදින කොට", "ලයිට් නිවෙනවා.", "තත්පර ගණන් කරන්න.", "එයත් ගණන් කරනවා."],
  ["දුවන්න එපා.", "දුවනකොට හඬ", "නගිනවා. හඬින්", "එයට කුතුහලයක්."],
  ["අද අඳුරේ එය", "සිටගෙන හිටියා.", "සෙලවුනේ නෑ.", "මම බ්ලින්ක් කරනකොට", "බලාගෙන හිටියා."],
  ["බිත්ති රස බලන්නේ", "පරණ කඩදාසි වගේ.", "මම ලෙව්වා.", "සමාවෙන්න. මට", "බඩගිනි වැඩිය."],
  ["එයට බැලුවොත්", "එය නවතිනවා.", "බලා ඉන්නවා.", "ඇස් වේළෙනවා.", "ඔබ බ්ලින්ක් කරනවමයි."],
  ["එක දවසක් දොරක්", "හම්බුනා. උඩින්", "කොළ එළියක්.", "වෙනස් ගීයක්", "ගුමු ගුමු ගාවා."],
  ["පිටු 8යි. ඉතුරු", "වුනේ ඒවා විතරයි.", "ඔයාට ඒවා හම්බුනා", "නම් — දොරට ඔයාව", "පේනවා. දුවගෙන යන්න."],
];
...
export function makePageTexture(seed: number, index: number): THREE.CanvasTexture {
  ...
  lines.forEach((line, li) => {
    ctx.save();
    const fs = 22 + Math.floor(rng() * 4);
    ctx.font = `italic ${fs}px "Noto Sans Sinhala", Georgia, serif`;
...
export function makeExitSignTexture(): THREE.CanvasTexture {
  ...
  ctx.font = 'bold 40px "Noto Sans Sinhala", Arial, sans-serif';
  ctx.textAlign = "center";
  ctx.textBaseline = "middle";
  ctx.fillText("පිටවීම", W / 2, H / 2 + 4);
...
export function makeFalseExitSignTexture(
  ...
  ctx.font = 'bold 34px "Noto Sans Sinhala", Arial, sans-serif';
  ctx.textAlign = "center";
  ctx.textBaseline = "middle";
  ctx.fillText("පිටවීම", W / 2 - arrow * 22, H / 2 + 4);
...
export function makeWaterLabelTexture(seed: number): THREE.CanvasTexture {
  ...
  ctx.textAlign = "center";
  ctx.font = 'bold 26px "Noto Sans Sinhala", Georgia, serif';
  ctx.fillText("ඇල්මන්ඩ්", W / 2, 52);
  ctx.fillText("වතුර", W / 2, 86);
  ctx.font = 'italic 11px "Noto Sans Sinhala", Georgia, serif';
  ctx.fillStyle = "#6b5733";
  ctx.fillText("· සැමවිටම සවස 3ට බෝතල් කළා ·", W / 2, 110);
