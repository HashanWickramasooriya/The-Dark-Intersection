...
const si = {
  ...
  "menu.sound": "ශබ්දය",
  "sound.title": "ශබ්දය",
  "sound.master": "සමස්ත ශබ්දය",
  "sound.music": "සංගීතය",
  "sound.effects": "ශබ්ද ප්‍රයෝග",
  "sound.back": "ආපසු",
  "menu.controlsBtn": "පාලනයන්",
  "controls.title": "පාලනයන්",
  "controls.back": "ආපසු",

  // ------------------------------------------------------------- credits
  "credits.title": "නිර්මාණකරුවන්",
  "credits.madeBy": "Hashan Wickramasooriya විසින් නිර්මාණය කළ ක්‍රීඩාවකි",
  "credits.description":
...
const en: Record<Key, string> = {
  ...
  "sound.back": "Back",
  "menu.controlsBtn": "Controls",
  "controls.title": "Controls",
  "controls.back": "Back",

  // ------------------------------------------------------------- credits
  "credits.title": "Credits",
  "credits.madeBy": "A game made by Hashan Wickramasooriya",
  "credits.description":
